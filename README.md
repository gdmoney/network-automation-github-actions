...
- these files are in **raw format** and use a [declarative](https://en.wikipedia.org/wiki/Declarative_programming) language syntax which describes the **desired** system state
